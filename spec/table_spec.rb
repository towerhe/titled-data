...
describe TitledData::Table do
  ...
  it 'returns the titles' do
    titled_data.titles.should == raw_data[0]
  end
  ...
  it 'returns the data section' do
    titled_data.data.should == raw_data[1..3]
  end

  it 'returns the specified row of data' do
    titled_data[0].data.should == raw_data[1]
    titled_data[1].data.should == raw_data[2]

    titled_data.get(0).data.should == raw_data[1]
    titled_data.get(1).data.should == raw_data[2]
  end
